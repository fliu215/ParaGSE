...
def mel_spectrogram(y, n_fft=1024, num_mels=80, sampling_rate=16000, hop_size=40, win_size=320, fmin=0, fmax=None, center=True):
...
def mag_pha_stft(y, n_fft=1024, hop_size=40, win_size=320, center=True):
